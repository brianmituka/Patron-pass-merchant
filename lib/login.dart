...
final logoColour = const Color(0xff2F2092);
 ...
 final FocusNode passwordFocusNode = FocusNode();
  ...
  final String loginUrl = 'http://api.patronpass.io/api/auth/login/';
  final String userUrl = 'http://api.patronpass.io/api/users/current';
            ...
            children: <Widget>[
              Stack(
                ...
                children: <Widget>[
                  Column(
                    children: <Widget>[
                      Padding( padding: EdgeInsets.only(top: mediaQueryData.padding.top + 40.0),),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: <Widget>[
                          Image(image: AssetImage("assets/img/pp.png"), height: 70.0,
                          ),
                        //    Padding(
                        //             padding:
...
class TextFromField extends StatelessWidget {
  ...
  TextFromField({this.email, this.icon, this.inputType, this.password, this.controller, this.focusNode, this.validator});
          ...
          body: JSON.jsonEncode(loginFormData)
             ...
             final String accessToken = loginResponseData['accessToken'];
              ...
              if (signUpResponseCode == 200) {
                http.get(userUrl, headers: {"Authorization": "Bearer $accessToken"}).then(
                  (http.Response response){
                    var data = JSON.jsonDecode(response.body);
                    print(data.toString());
                    print(response.statusCode);
                    if (response.statusCode == 200 && data['userType'] == 'Merchant') {
            ...
            pageBuilder: (_, __, ___) => new LandingPage(),
            ...
            transitionsBuilder:
              ...
              return Opacity(
                ...
                child: child,
                  ...
                  passwordController.clear();
                 emailController.clear();
                 showInSnackBar("An Error Occured. Check your password or email");
