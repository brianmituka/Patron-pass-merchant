...
class _LandingState extends State<LandingPage> with TickerProviderStateMixin{
  Reedemer _reedemer = new Reedemer(type: "campaign", points: "10", campaignId: 20 );
...
Future<void> getUserDetails() async {
     ...
     await http.get(userUrl, headers: {"Authorization": "Bearer $accessToken"}).then(
    ...
    Future scan () async {
      ...
      //print(payload);
       if (payload['campaignId'] != null) {
         Reedemer _reedemer = new Reedemer(type: "campaign", campaignId: payload['campaignId'], userId: payload['customerId'], couponCode: payload['couponCode'] );
          ...
          Reedemer _reedemer = new Reedemer(type: "points", userId: payload['id']);
          Navigator.of(context).push(PageRouteBuilder(
            pageBuilder: (_, __, ___) => new Redeem(_reedemer),
            transitionDuration: Duration(milliseconds: 900),
